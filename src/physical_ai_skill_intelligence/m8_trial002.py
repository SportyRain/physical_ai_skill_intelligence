...
For the termination-validation continuation, the same runner forwards the
...
RUNNER_VERSION = "M8_TRIAL002_RUNNER_V2_TERMINATION_CONTRACT"
...
def run_trial002_positive_axis_5mm(
    *,
    ...
    the provider adapter; the runner neither polls it nor adds another cancellation
    mechanism.
    """
